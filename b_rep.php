...
<body>
	<ul>
		...
		<li><a href = "index_rep.php">Listar</a></li>
		<li><a href = "sair.php">Sair do Sistema</a></li>
	</ul>
    
	<center><h1 id="titulo">Consultar Reposição</h1>

    <div class="pesq">
	
	<div class="form1">
		<form method="POST" id="form_1" action="pro_pesq_rep.php">
			<div class="alinhar">

			<h1>Pesquisar</h1><br>

				<p>
							<input type="radio" name="rep" value="nome" checked/>Nome|
							<input type="radio" name="rep" value="materia"/>Materia
