...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
		<title>Deletar Substituição</title>
	...
	<ul>
		...
		<center><h1>Deletar substituição</h1>
		<?php
		...
		?>
		<form method="POST" action="pro_delete_subst.php">
		...
		<p>Codigo: <?php echo $row_subst['codigo']; ?></p>
		<p>Nome: <?php echo $row_subst['nome']; ?></p>
		<h3> Essa operação é irreversivel - Deseja realmente excluir esta substituição?</h3>
		<div class="botao">
		<input type="submit" class="btn btn-outline-success" value="Sim">

		<a href='index_subst.php?pagina=1'>
