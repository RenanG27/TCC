...
.alinhar{
	...
	<ul>
		...
		<center><h1>Cadastrar substituição</h1>
		<?php
		...
		?>
		<div class="form1">
			<form method ="POST" id="form_1" action="pro_cad_subst.php">
				<div class="alinhar">
				...
				<div class="cb_sql">
					<label class='label2' for="remunerada">6. Essa substituição sera remunerada?: </label>
