...
.alinhar{
	...
	<ul>
		...
		?>
		<div class="form1">
			<form method ="POST" id="form_1" action="pro_cad_cursos.php">
				<div class="alinhar">
					<div class="label">
						<div class="mb-3">
							<!-- Nome do curso -->
							<label for="formGroupExampleInput" class="form-label">Nome: </label>
							<input type="text" name="nome" class="form-control" id="formGroupExampleInput" required placeholder="Digite o nome do curso">
						</div>
					</div>
				...
				<div class="label">
					<div class="mb-3">
						...
						<input type="number" name="modulo" class="form-control" id="formGroupExampleInput" required placeholder="0"><br><br>
					</div>
				</div>
			</div>
