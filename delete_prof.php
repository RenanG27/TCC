...
<html lang="pt-br">
	...
	<ul>
		...
		<center><h1>Deletar Professor</h1>
		<?php
		...
		?>
		<form method="POST" action="pro_delete_prof.php">
		
		<input type="hidden" name="codigo" value="<?php echo 
		$row_professor['codigo'];?>">
		<input type="hidden" name="nome" value="<?php echo 
		$row_professor['nome'];?>">
		
		<p>Codigo: <?php echo $row_professor['codigo']; ?></p>
		<p>Nome: <?php echo $row_professor['nome']; ?></p>
		...
		<a href='index_prof.php?pagina=1'>
