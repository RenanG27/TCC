...
<body>
	...
	<center><h1>Consultar Reposições</h1>
    ...
    if (isset($_POST["rep"])) 
{
    ...
    if($_POST["rep"] == "nome")
    {
        ...
        $result_rep = "SELECT * FROM rep WHERE rep_nome LIKE '%$pesquisar%'";
        $result_rep = mysqli_query($conn, $result_rep);
    }
    ...
    {
        $pesquisar = $_POST['pesquisar'];
        $result_rep = "SELECT * FROM rep WHERE rep_dta_rep LIKE '%$pesquisar%'";
        $result_rep = mysqli_query($conn, $result_rep);;
    }


    if($_POST["rep"] == "materia")
    {
        $pesquisar = $_POST['pesquisar'];
        $sql = "SELECT * FROM rep WHERE rep_mat LIKE '%$pesquisar%'";
        $result_rep = mysqli_query($conn, $sql);;
    }
