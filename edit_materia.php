...
.alinhar{
	...
	<ul>
		...
		?>
		<div class="form1">
			<form method ="POST" id="form_1" action="proc_edit_materia.php">
			<div class="alinhar">
				<div class="label">
					<input type="hidden" name="codigo" value="<?php echo $row_materia['codigo']; ?>">
					<div class="mb-3">
						<!--Nome da matéria-->
						<label for="formGroupExampleInput" class="form-label">Nome:</label>
						<input type="text" name="nome" class="form-control" id="formGroupExampleInput" value="<?php echo $row_materia['nome'] ?>">
					</div>
				
						<!-- Selecione o modulo-->
						<div class="modulo">
							<label for="formGroupExampleInput" class="form-label">Modulo?: </label>
							<INput type="number" name="cu_mod" class="form-control" id="formGroupExampleInput" value="<?php echo $row_materia['cu_mod']?>"><br>
						</div>
				</div>
    ...
    <!-- Select de cursos-->
				<?php
					...
					<option value="" selected="selected"> '. $row_materia['cu_nome'] . '</option></div>';
				...
				<?php
					...
					<option value=" " selected="selected">'. $row_materia['prof_nome'] . '</option></div>';
					while($elemento = mysqli_fetch_array($resultado))
					{
